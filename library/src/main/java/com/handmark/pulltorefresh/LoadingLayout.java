	...
	public LoadingLayout(Context context, final Mode mode, final Orientation scrollDirection, TypedArray attrs) {
		...
		switch (mode) {
			case PULL_FROM_END:
				...
				// Load in labels
				mPullLabel = context.getString(R.string.pull_to_up_refresh_from_bottom_pull_label);
			...
			default:
				...
				// Load in labels
				mPullLabel = context.getString(R.string.pull_to_down_refresh_from_bottom_pull_label);
